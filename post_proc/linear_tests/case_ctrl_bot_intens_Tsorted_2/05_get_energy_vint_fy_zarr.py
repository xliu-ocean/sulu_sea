...
time_vals = np.asarray(Fy["time"].values)
y_vals = np.asarray(Fy["y"].values)
x_vals = np.asarray(Fy["x"].values)
...
# write_ver_int(os.path.join(zarr_dir_2, "fx_ver_int.zarr"), "fx_ver_int", fx_ver_int)
