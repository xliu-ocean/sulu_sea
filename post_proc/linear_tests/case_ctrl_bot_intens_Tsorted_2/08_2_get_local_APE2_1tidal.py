...
OUTPUT_ZARR = ZARR_DIR / "APE2_1tidal.zarr"
...
def compute_APE2_local(
    ...
    # rho_ref_on_z = interp_extrap(z, z_unique, rho_ref_unique)
    ...
    # F_z = interp_extrap(z, z_faces, F_faces)
    # F_zref = interp_extrap(z_ref, z_faces, F_faces)
    F_func = interp1d(
        z_faces,
        F_faces,
        bounds_error=False,
...
def main() -> None:
    if len(sys.argv) < 2:
        raise SystemExit("Usage: python 08_2_get_local_APE2_1tidal.py <k>")
